...
export default {
  ...
  addOrg: params => {
    return service.post('/home/company/addOrg', params)
  },
  deleteOrg: params => {
    return service.post('/home/company/deleteOrg', params)
  },
  addNode: params => {
    return service.post('/home/company/addNode', params)
  },
  deleteNode: params => {
    return service.post('/home/company/deleteNode', params)
  },

  //查询租户下的所有用户
  queryUserFromTenant: params => {
    return service.post('/home/user/queryUserFromTenant', params)
  },
  listChildren:params=>{
    return service.post('/home/department/listChildren', params)
  },
