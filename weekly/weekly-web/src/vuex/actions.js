...
export const getAllOrgList = ({ commit }, params) => {
  return Api.getAllOrgList(params).then(response => {
    return response
  })
}
export const addOrg = ({ commit }, params) => {
  return Api.addOrg(params).then(response => {
    return response
  })
}
export const deleteOrg = ({ commit }, params) => {
  return Api.deleteOrg(params).then(response => {
    return response
  })
}
export const addNode = ({ commit }, params) => {
  return Api.addNode(params).then(response => {
    return response
  })
}
export const deleteNode = ({ commit }, params) => {
  return Api.deleteNode(params).then(response => {
    return response
  })
}

export const queryUserFromTenant = ({ commit }, params) => {
  return Api.queryUserFromTenant(params).then(response => {
    return response
  })
}

export const listChildren = ({ commit }, params) => {
  return Api.listChildren(params).then(response => {
    return response
  })
}


export const queryApplicationInfo = ({ commit }, params) => {
  return Api.queryApplicationInfo(params).then(response => {
    return response
  })
}
